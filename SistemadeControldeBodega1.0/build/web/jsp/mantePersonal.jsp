...
<html>
    ...
    <script>
        function cargar(a, b, c, d)
        {
            document.frmPersonal.txtIdPersonal.value = a;
            document.frmPersonal.txtNombre.value = b;
            document.frmPersonal.txtApellido.value = c;
            document.frmPersonal.txtEdad.value = d;
    ...
    <script>
        ...
        location.replace('jsp/mantePersonal.jsp');
    </script>
    <%
        }
        String user = "";
        ...
        <div id="wrapper">
                            ...
                            <li>
                                ...
                                <div id="subPages" class="collapse ">
                                    <ul class="nav">
                                        ...
                                        <li><a href="../jsp/mantePersonal.jsp" class="active"><i class="fa fa-male"></i> Personal</a></li>
            ...
            <div class="main">
                <div class="main-content">
                    <div class="container-fluid">
                        <h3 class="page-title"><i class="fa fa-cogs"></i> Mantenimiento Personal</h3>
                        <div class="row">
                            <div class="col-md-6">
                                <form name="frmPersonal" action="../procesoPersonal" method="POST">
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            <label>ID: </label>
                                            <input type="number" class="form-control" name="txtIdPersonal" readonly placeholder="ID">
                                            <br>
                                            <label>Nombre: </label>
                                            <input type="text" pattern="[A-Z a-z ]+" autocomplete="off" class="form-control" name="txtNombre" required autofocus placeholder="">
                                            <br>
                                            <label>Apellido: </label>
                                            <input type="text" pattern="[A-Z a-z ]+" autocomplete="off" class="form-control" name="txtApellido" required  placeholder="">
                                            <br>
                                            <label>Edad: </label>
                                            <input type="number" min="18" autocomplete="off" class="form-control" name="txtEdad" required  placeholder="">
                                            <br>
                                            <p class="demo-button">
                            ...
                            <div class="col-md-6">
                                <div class="panel">
                                    <div class="panel-heading">
                                        <h3 class="panel-title"><i class="fa fa-male"></i> Tabla Personal</h3>
                                    </div>
                                    <div class="panel-body">
                                            ...
                                            <table id="datos" class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><%=pe.getEdad()%></td>
                                                        <td><a class="btn btn-success" href="javascript:cargar('<%=pe.getIdPersonal()%>','<%=pe.getNombre()%>','<%=pe.getApellido()%>','<%=pe.getEdad()%>');">Seleccionar</a></td>
                                                    </tr>
                                                    <%
                                                        }
                                                    %>
