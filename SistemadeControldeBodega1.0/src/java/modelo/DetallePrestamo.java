...
public class DetallePrestamo {
    ...
    public DetallePrestamo(int idPrestamo, int idPersonal, int idHerramienta, String nombreHerramienta, String fechaHora, String nombre, String apellido, int idCategoria, String uso, String estado, String presPor) {
